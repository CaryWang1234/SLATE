...
MODEL_REGISTRY: dict[str, list[dict[str, Any]]] = {
    ...
    "domestic": [
        {"id": "deepseek-chat", "name": "DeepSeek-V3", "provider": "openai",
         "base_url": "https://api.deepseek.com/v1", "context_window": 65536},
        {"id": "deepseek-reasoner", "name": "DeepSeek-R1", "provider": "openai",
         "base_url": "https://api.deepseek.com/v1", "context_window": 65536},
        {"id": "moonshot-v1-128k", "name": "Kimi 128K", "provider": "openai",
         "base_url": "https://api.moonshot.cn/v1", "context_window": 131072},
        {"id": "doubao-pro-32k", "name": "Doubao Pro 32K", "provider": "openai",
         "base_url": "https://ark.cn-beijing.volces.com/api/v3", "context_window": 32768},
        {"id": "qwen-max", "name": "Qwen-Max", "provider": "openai",
         "base_url": "https://dashscope.aliyuncs.com/compatible-mode/v1", "context_window": 32768},
        {"id": "glm-4-plus", "name": "GLM-4-Plus", "provider": "openai",
         "base_url": "https://open.bigmodel.cn/api/paas/v4", "context_window": 128000},
    ],
    "local": [
