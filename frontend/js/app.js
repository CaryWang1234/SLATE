...
import { state, subscribe, setCurrentModel, setModelKey, getModelKey, hasModelKey, addCustomModel, updateCustomModel, removeCustomModel, setModelRegistry, loadPersistent, loadSharedPersistent, savePersistent, toggleTheme, resetUsage } from "./store.js?v=20260817-60";
import { initI18n, t } from "./services/i18n.js?v=20260817-60";
import { get, post, put } from "./services/api.js?v=20260817-60";
import { dlgConfirm } from "./services/dialog.js?v=20260817-60";
import { fmtTokens, tokenEquivalence } from "./services/usage.js?v=20260817-60";
import { initChat, refreshConversationList } from "./components/chat.js?v=20260817-60";
import { initWhiteboard } from "./components/whiteboard.js?v=20260817-60";
import { initPromptFactory } from "./components/prompt_factory.js?v=20260817-60";
import { initSkillPanel } from "./components/skill_panel.js?v=20260817-60";
import { initTeamPanel } from "./components/team.js?v=20260817-60";
import { initProjectBar } from "./components/project_bar.js?v=20260817-60";
import { initMemoryPanel } from "./components/memory.js?v=20260817-60";
import { initExpertsPanel } from "./components/experts.js?v=20260817-60";
import { initSchedule } from "./components/schedule.js?v=20260817-60";
import { initRiskGuard } from "./services/riskguard.js?v=20260817-60";
import { initUnderstandPanel } from "./components/understand.js?v=20260817-60";
import { getCurrentProject, browseFiles } from "./services/project.js?v=20260817-60";
import { setProject, setProjectFileTree } from "./store.js?v=20260817-60";
...
async function saveSettings() {
  ...
  if (constText) {
    try {
      ...
      if (state.project) {
        const { updateProjectConfig } = await import("./services/project.js?v=20260817-60");
...
async function init() {
  ...
  // 自动恢复上次打开的项�?  if (state._lastProjectPath) {
    ...
    if (res.code === 0 && res.data) {
      ...
      const { openProject } = await import("./services/project.js?v=20260817-60");
