...
import { state, subscribe, setCurrentModel, setModelKey, getModelKey, hasModelKey, addCustomModel, updateCustomModel, removeCustomModel, setModelRegistry, loadPersistent, loadSharedPersistent, savePersistent, toggleTheme, CONTEXT_CAP_STOPS, getContextCap, setModelContextCap, contextBudgetOf, declaredContextWindow, defaultContextCap, fmtContextTokens, setTaskListSort, effectiveConstitution, constitutionScope, setConstitution, setBgAutoResume, setMaxParallelRuns, setMaxConcurrentRunsPerProject, setBackgroundRuns, setDefaultPermissionMode } from "./store.js?v=20260925-010";
import { initI18n, t } from "./services/i18n.js?v=20260925-010";
import { iconSvgEl } from "./services/icons.js?v=20260925-010";
import { groupConversationsByProject, taskStatusOf, statusBadge, statusMark, STATUS, SORT_MODES, normalizeTaskListSort } from "./services/task_list.js?v=20260925-010";
import { get, post, put } from "./services/api.js?v=20260925-010";
import { dlgConfirm } from "./services/dialog.js?v=20260925-010";
import { fmtTokens, tokenEquivalence } from "./services/usage.js?v=20260925-010";
import { initChat, refreshConversationList, openConversation } from "./components/chat.js?v=20260925-010";
import { initWhiteboard, refreshWhiteboard } from "./components/whiteboard.js?v=20260925-010";
import { initPromptFactory } from "./components/prompt_factory.js?v=20260925-010";
import { initSkillPanel } from "./components/skill_panel.js?v=20260925-010";
import { initMcpServerPanel } from "./components/mcp_server_panel.js?v=20260925-010";
import { initTeamPanel } from "./components/team.js?v=20260925-010";
import { initProjectBar } from "./components/project_bar.js?v=20260925-010";
import { initSessionSummary } from "./components/session_summary.js?v=20260925-010";
import { initApiTest, refreshApiTestModels } from "./components/api_test.js?v=20260925-010";
import { initTypingGame } from "./components/typing_game.js?v=20260925-010";
import { renderActivityHeatmap } from "./components/usage_heatmap.js?v=20260925-010";
import { initMemoryPanel } from "./components/memory.js?v=20260925-010";
import { initExpertsPanel } from "./components/experts.js?v=20260925-010";
import { initSchedule } from "./components/schedule.js?v=20260925-010";
import { initRiskGuard } from "./services/riskguard.js?v=20260925-010";
import { initAiFeatureSettings, renderAiFeatureSettings } from "./services/ai_features.js?v=20260925-010";
import { initUnderstandPanel } from "./components/understand.js?v=20260925-010";
import { getCurrentProject, browseFiles } from "./services/project.js?v=20260925-010";
import { setProject, setProjectFileTree } from "./store.js?v=20260925-010";
import { cxDockIn, cxPanelIn, cxHistReveal } from "./services/cx_motion.js?v=20260925-010";
import { installErrorSink } from "./services/error_sink.js?v=20260925-010";
...
function applyNotificationSettings() {
  ...
  if (state.notifications.systemNotifEnabled && "Notification" in window && Notification.permission === "default") {
    import("./services/notify.js?v=20260925-010").then(({ requestNotificationPermission }) => {
...
function buildCodexHistGroup(name, convs, ctx, meta = {}) {
  ...
  if (projectId) {
    ...
    open.addEventListener("click", async (e) => {
      e.stopPropagation();
      const { switchToProject } = await import("./services/project_scene.js?v=20260925-010");
    ...
    pin.addEventListener("click", async (e) => {
      e.stopPropagation();
      const { patchRegistry } = await import("./services/project.js?v=20260925-010");
      const { refreshRegistry } = await import("./services/project_scene.js?v=20260925-010");
  ...
  if (constText) {
    ...
    if (constData) {
      if (state.project) {
        ...
        const { updateProjectConfig } = await import("./services/project.js?v=20260925-010");
...
async function init() {
  ...
  // 拿它补登一次，用户不会感到"项目不见了"。
  try {
    const { refreshRegistry, restoreScene } = await import("./services/project_scene.js?v=20260925-010");
    const res = await getCurrentProject();
    let project = res.code === 0 ? res.data : null;
    if (!project && state._lastProjectPath) {
      const { openProject } = await import("./services/project.js?v=20260925-010");
