...
import { state, subscribe, setCurrentModel, setModelKey, getModelKey, hasModelKey, addCustomModel, updateCustomModel, removeCustomModel, setModelRegistry, loadPersistent, loadSharedPersistent, savePersistent, toggleTheme, resetUsage } from "./store.js?v=20260826-110";
import { initI18n, t } from "./services/i18n.js?v=20260826-110";
import { get, post, put } from "./services/api.js?v=20260826-110";
import { dlgConfirm } from "./services/dialog.js?v=20260826-110";
import { fmtTokens, tokenEquivalence } from "./services/usage.js?v=20260826-110";
import { initChat, refreshConversationList } from "./components/chat.js?v=20260826-110";
import { initWhiteboard, refreshWhiteboard } from "./components/whiteboard.js?v=20260826-110";
import { initPromptFactory } from "./components/prompt_factory.js?v=20260826-110";
import { initSkillPanel } from "./components/skill_panel.js?v=20260826-110";
import { initMcpServerPanel } from "./components/mcp_server_panel.js?v=20260826-110";
import { initTeamPanel } from "./components/team.js?v=20260826-110";
import { initProjectBar } from "./components/project_bar.js?v=20260826-110";
import { initMemoryPanel } from "./components/memory.js?v=20260826-110";
import { initExpertsPanel } from "./components/experts.js?v=20260826-110";
import { initSchedule } from "./components/schedule.js?v=20260826-110";
import { initRiskGuard } from "./services/riskguard.js?v=20260826-110";
import { initUnderstandPanel } from "./components/understand.js?v=20260826-110";
import { getCurrentProject, browseFiles } from "./services/project.js?v=20260826-110";
import { setProject, setProjectFileTree } from "./store.js?v=20260826-110";
...
function applyNotificationSettings() {
  ...
  if (state.notifications.systemNotifEnabled && "Notification" in window && Notification.permission === "default") {
    import("./services/notify.js?v=20260826-110").then(({ requestNotificationPermission }) => {
...
async function saveSettings() {
  ...
  if (constText) {
    try {
      ...
      if (state.project) {
        const { updateProjectConfig } = await import("./services/project.js?v=20260826-110");
...
async function init() {
  ...
  if (state._lastProjectPath) {
    ...
    if (res.code === 0 && res.data) {
      ...
      const { openProject } = await import("./services/project.js?v=20260826-110");
