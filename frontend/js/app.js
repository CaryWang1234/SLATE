...
import { state, subscribe, setCurrentModel, setModelKey, getModelKey, hasModelKey, addCustomModel, updateCustomModel, removeCustomModel, setModelRegistry, loadPersistent, loadSharedPersistent, savePersistent, toggleTheme, resetUsage } from "./store.js?v=20260818-108";
import { initI18n, t } from "./services/i18n.js?v=20260818-108";
import { get, post, put } from "./services/api.js?v=20260818-108";
import { dlgConfirm } from "./services/dialog.js?v=20260818-108";
import { fmtTokens, tokenEquivalence } from "./services/usage.js?v=20260818-108";
import { initChat, refreshConversationList } from "./components/chat.js?v=20260818-108";
import { initWhiteboard } from "./components/whiteboard.js?v=20260818-108";
import { initPromptFactory } from "./components/prompt_factory.js?v=20260818-108";
import { initSkillPanel } from "./components/skill_panel.js?v=20260818-108";
import { initMcpServerPanel } from "./components/mcp_server_panel.js?v=20260818-108";
import { initTeamPanel } from "./components/team.js?v=20260818-108";
import { initProjectBar } from "./components/project_bar.js?v=20260818-108";
import { initMemoryPanel } from "./components/memory.js?v=20260818-108";
import { initExpertsPanel } from "./components/experts.js?v=20260818-108";
import { initSchedule } from "./components/schedule.js?v=20260818-108";
import { initRiskGuard } from "./services/riskguard.js?v=20260818-108";
import { initUnderstandPanel } from "./components/understand.js?v=20260818-108";
import { getCurrentProject, browseFiles } from "./services/project.js?v=20260818-108";
import { setProject, setProjectFileTree } from "./store.js?v=20260818-108";
...
function applyNotificationSettings() {
  ...
  if (state.notifications.systemNotifEnabled && "Notification" in window && Notification.permission === "default") {
    import("./services/notify.js?v=20260818-108").then(({ requestNotificationPermission }) => {
...
async function saveSettings() {
  ...
  if (constText) {
    try {
      ...
      if (state.project) {
        const { updateProjectConfig } = await import("./services/project.js?v=20260818-108");
...
async function init() {
  ...
  if (state._lastProjectPath) {
    ...
    if (res.code === 0 && res.data) {
      ...
      const { openProject } = await import("./services/project.js?v=20260818-108");
