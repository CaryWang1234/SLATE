...
import { get, post, del, patch, streamChat, upload, REASONING_PREFIX } from "../services/api.js?v=20260817-58";
import { buildMessages, getDefaultParams, getOutputMaxTokens } from "../services/adapter.js?v=20260817-58";
import { detectToolCalls, stripToolCalls, executeToolCalls, hasTruncatedTail } from "../services/tools.js?v=20260817-58";
import { renderMarkdown } from "../services/markdown.js?v=20260817-58";
import { openMemoryModal, openSnippetModal, autoRefineMemoryAndProfile } from "./memory.js?v=20260817-58";
import { getExpertsCached } from "./experts.js?v=20260817-58";
import { addToolStepCard, updateToolStepCard } from "./whiteboard.js?v=20260817-58";
import { loadExperts, getExpert, readExpertFile } from "../services/experts.js?v=20260817-58";
import { fmtTokens, tokenEquivalence } from "../services/usage.js?v=20260817-58";
import { fileTypeIcon } from "../services/file_icons.js?v=20260817-58";
import { dlgConfirm, dlgPrompt, dlgToast } from "../services/dialog.js?v=20260817-58";
import * as grindSvc from "../services/grind.js?v=20260817-58";
...
function openCompressModal() {
  ...
  if (state.messages.length < 4) {
    import("../app.js?v=20260817-58").then(({ toast }) => toast("当前对话还不需要压�?));
    return;
  }
...
function initChat() {
  ...
  expertSelect?.addEventListener("change", async () => {
    ...
    try {
      const { getExpert } = await import("../services/experts.js?v=20260817-58");
