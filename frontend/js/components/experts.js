...
import { state, setActiveExpertId } from "../store.js?v=20260925-010";
import {
...
} from "../services/experts.js?v=20260925-010";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260925-010");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
