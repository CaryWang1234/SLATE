...
import { state, setActiveExpertId } from "../store.js?v=20260826-110";
import {
...
} from "../services/experts.js?v=20260826-110";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260826-110");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
