...
import { state, setActiveExpertId } from "../store.js?v=20260922-002";
import {
...
} from "../services/experts.js?v=20260922-002";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260922-002");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
