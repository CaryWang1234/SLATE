...
import { state, setActiveExpertId } from "../store.js?v=20260815-55";
import {
...
} from "../services/experts.js?v=20260815-55";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260815-55");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
