...
import { state, setActiveExpertId } from "../store.js?v=20260830-003";
import {
...
} from "../services/experts.js?v=20260830-003";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260830-003");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
