...
import { state, setActiveExpertId } from "../store.js?v=20260816-56";
import {
...
} from "../services/experts.js?v=20260816-56";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260816-56");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
