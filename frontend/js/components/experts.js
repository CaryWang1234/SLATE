...
import { state, setActiveExpertId } from "../store.js?v=20260818-69";
import {
...
} from "../services/experts.js?v=20260818-69";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260818-69");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
