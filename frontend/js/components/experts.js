...
import { state, setActiveExpertId } from "../store.js?v=20260907-001";
import {
...
} from "../services/experts.js?v=20260907-001";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260907-001");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
