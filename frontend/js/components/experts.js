...
import { state, setActiveExpertId } from "../store.js?v=20260817-63";
import {
...
} from "../services/experts.js?v=20260817-63";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260817-63");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
