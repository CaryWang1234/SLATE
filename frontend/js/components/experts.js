...
import { state, setActiveExpertId } from "../store.js?v=20260828-134";
import {
...
} from "../services/experts.js?v=20260828-134";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260828-134");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
