...
import { state, setActiveExpertId } from "../store.js?v=20260808-21";
import {
...
} from "../services/experts.js?v=20260808-21";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260808-21");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
