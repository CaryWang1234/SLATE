...
import { state, setActiveExpertId } from "../store.js?v=20260925-011";
import {
...
} from "../services/experts.js?v=20260925-011";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260925-011");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
