...
import { state, setActiveExpertId } from "../store.js?v=20260817-64";
import {
...
} from "../services/experts.js?v=20260817-64";
...
async function toast(msg) {
  try {
    const { toast: showToast } = await import("../app.js?v=20260817-64");
    showToast(msg);
  } catch {
    console.warn(msg);
  }
