...
import { get, post, del } from "../services/api.js?v=20260818-75";
import { dlgPrompt, dlgConfirm } from "../services/dialog.js?v=20260818-75";
import { refreshSkills } from "./skill_panel.js?v=20260818-75";
