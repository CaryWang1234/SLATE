...
import { get, post, del } from "../services/api.js?v=20260829-141";
import { dlgPrompt, dlgConfirm } from "../services/dialog.js?v=20260829-141";
import { refreshSkills } from "./skill_panel.js?v=20260829-141";
