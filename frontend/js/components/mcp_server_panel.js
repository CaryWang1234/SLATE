...
import { get, post, del } from "../services/api.js?v=20260907-016";
import { dlgPrompt, dlgConfirm } from "../services/dialog.js?v=20260907-016";
import { refreshSkills } from "./skill_panel.js?v=20260907-016";
