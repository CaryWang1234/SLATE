...
import { get, post, del } from "../services/api.js?v=20260818-96";
import { dlgPrompt, dlgConfirm } from "../services/dialog.js?v=20260818-96";
import { refreshSkills } from "./skill_panel.js?v=20260818-96";
