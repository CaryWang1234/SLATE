...
import { get, post, del, patch, streamChat } from "../services/api.js?v=20260817-61";
import { dlgConfirm, dlgPrompt } from "../services/dialog.js?v=20260817-61";
...
function initMemoryPanel() {
  ...
  if (btnSaveProfile) btnSaveProfile.addEventListener("click", () => {
    saveProfileFromForm();
    import("../app.js?v=20260817-61").then(({ toast }) => toast("资料已保�?));
  });
