...
import { get, post, del, patch, streamChat } from "../services/api.js?v=20260818-71";
import { dlgConfirm, dlgPrompt } from "../services/dialog.js?v=20260818-71";
import { t } from "../services/i18n.js?v=20260818-71";
import { initVaultPanel, openVaultPanel } from "./vault.js?v=20260818-71";
...
function initMemoryPanel() {
  ...
  if (btnSaveProfile) btnSaveProfile.addEventListener("click", () => {
    saveProfileFromForm();
    import("../app.js?v=20260818-71").then(({ toast }) => toast("资料已保�?));
  });
