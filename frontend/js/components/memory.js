...
import { get, post, del, patch, streamChat } from "../services/api.js?v=20260817-62";
import { dlgConfirm, dlgPrompt } from "../services/dialog.js?v=20260817-62";
...
function initMemoryPanel() {
  ...
  if (btnSaveProfile) btnSaveProfile.addEventListener("click", () => {
    saveProfileFromForm();
    import("../app.js?v=20260817-62").then(({ toast }) => toast("资料已保�?));
  });
