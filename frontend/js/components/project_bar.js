...
import { state, subscribe, setProject, setProjectFileTree } from "../store.js?v=20260910-006";
import { openProject, closeProject, browseFiles, listDrives } from "../services/project.js?v=20260910-006";
import { fileTypeIcon, extToLang } from "../services/file_icons.js?v=20260910-006";
import { iconSvgEl, setIconText } from "../services/icons.js?v=20260910-006";
...
function renderProjectBar() {
  ...
  if (proj) {
    ...
    understandBtn.addEventListener("click", () => {
      import("./understand.js?v=20260910-006")
    ...
    reviewBtn.addEventListener("click", () => {
      import("./review.js?v=20260910-006")
