...
import { state, subscribe, setProject, setProjectFileTree } from "../store.js?v=20260815-51";
import { openProject, closeProject, browseFiles, listDrives } from "../services/project.js?v=20260815-51";
import { fileTypeIcon, extToLang } from "../services/file_icons.js?v=20260815-51";
import { dlgConfirm, dlgToast } from "../services/dialog.js?v=20260815-51";
...
function renderProjectBar() {
  ...
  if (proj) {
    ...
    reviewBtn.addEventListener("click", () => {
      import("./review.js?v=20260817-63")
