...
import { state, subscribe, setProject, setProjectFileTree } from "../store.js?v=20260907-003";
import { openProject, closeProject, browseFiles, listDrives } from "../services/project.js?v=20260907-003";
import { fileTypeIcon, extToLang } from "../services/file_icons.js?v=20260907-003";
import { iconSvgEl, setIconText } from "../services/icons.js?v=20260907-003";
import { dlgConfirm, dlgToast } from "../services/dialog.js?v=20260907-003";
...
function renderProjectBar() {
  ...
  if (proj) {
    ...
    understandBtn.addEventListener("click", () => {
      import("./understand.js?v=20260907-003")
    ...
    reviewBtn.addEventListener("click", () => {
      import("./review.js?v=20260907-003")
