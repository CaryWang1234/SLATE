...
import { state, subscribe, setProject, setProjectFileTree } from "../store.js?v=20260925-010";
import {
...
} from "../services/project.js?v=20260925-010";
import { refreshRegistry, saveScene, switchToProject, restoreScene } from "../services/project_scene.js?v=20260925-010";
import { fileTypeIcon, extToLang } from "../services/file_icons.js?v=20260925-010";
import { iconSvgEl, setIconText } from "../services/icons.js?v=20260925-010";
...
function renderProjectBar() {
  ...
  if (proj) {
    ...
    understandBtn.addEventListener("click", () => {
      import("./understand.js?v=20260925-010")
    ...
    reviewBtn.addEventListener("click", () => {
      import("./review.js?v=20260925-010")
