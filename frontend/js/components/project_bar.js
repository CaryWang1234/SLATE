...
import { state, subscribe, setProject, setProjectFileTree } from "../store.js?v=20260913-007";
import { openProject, closeProject, browseFiles, listDrives } from "../services/project.js?v=20260913-007";
import { fileTypeIcon, extToLang } from "../services/file_icons.js?v=20260913-007";
import { iconSvgEl, setIconText } from "../services/icons.js?v=20260913-007";
import { dlgConfirm, dlgToast } from "../services/dialog.js?v=20260913-007";
...
function renderProjectBar() {
  ...
  if (proj) {
    ...
    understandBtn.addEventListener("click", () => {
      import("./understand.js?v=20260913-007")
    ...
    reviewBtn.addEventListener("click", () => {
      import("./review.js?v=20260913-007")
