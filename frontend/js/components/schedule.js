...
import { state } from "../store.js?v=20260922-002";
import { get, post, del, patch } from "../services/api.js?v=20260922-002";
import { dlgConfirm } from "../services/dialog.js?v=20260922-002";
import { t as tr } from "../services/i18n.js?v=20260922-002"; // 任务变量也叫 t，此处别名避免遮蔽
...
async function toast(msg) {
  try {
    const app = await import("../app.js?v=20260922-002");
    app.toast(msg);
  } catch {}
}
