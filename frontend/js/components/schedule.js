...
import { state } from "../store.js?v=20260907-017";
import { get, post, del, patch } from "../services/api.js?v=20260907-017";
import { dlgConfirm } from "../services/dialog.js?v=20260907-017";
import { t as tr } from "../services/i18n.js?v=20260907-017"; // 任务变量也叫 t，此处别名避免遮蔽
...
async function toast(msg) {
  try {
    const app = await import("../app.js?v=20260907-017");
    app.toast(msg);
  } catch {}
}
