...
import { state, subscribe } from "../store.js?v=20260913-008";
import { t } from "../services/i18n.js?v=20260913-008";
import { toolLabel, toolArgsSummary, toolIcon, fileIcon, commandOf } from "../services/tool_meta.js?v=20260913-008";
