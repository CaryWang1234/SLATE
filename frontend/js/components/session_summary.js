...
import { state, subscribe } from "../store.js?v=20260922-002";
import { t } from "../services/i18n.js?v=20260922-002";
import { toolLabel, toolArgsSummary, toolIcon, fileIcon, commandOf } from "../services/tool_meta.js?v=20260922-002";
