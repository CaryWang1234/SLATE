...
import { state, subscribe, setSkills } from "../store.js?v=20260911-001";
import { get, post, del, upload } from "../services/api.js?v=20260911-001";
import { guardSkillParams } from "../services/riskguard.js?v=20260911-001";
