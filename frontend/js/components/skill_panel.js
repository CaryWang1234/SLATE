...
import { state, subscribe, setSkills } from "../store.js?v=20260829-143";
import { get, post, del, upload } from "../services/api.js?v=20260829-143";
import { guardSkillParams } from "../services/riskguard.js?v=20260829-143";
