...
import { state, subscribe, setSkills } from "../store.js?v=20260907-018";
import { get, post, del, upload } from "../services/api.js?v=20260907-018";
import { guardSkillParams } from "../services/riskguard.js?v=20260907-018";
