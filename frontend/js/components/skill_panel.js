...
import { state, subscribe, setSkills, setActions } from "../store.js?v=20260921-001";
import { get, post, put, del, upload } from "../services/api.js?v=20260921-001";
import { guardSkillParams } from "../services/riskguard.js?v=20260921-001";
