...
import { get, post, patch, streamChat, REASONING_PREFIX, REASONING_INLINE_PREFIX } from "../services/api.js?v=20260907-003";
import { buildMessages, getDefaultParams, getOutputMaxTokens } from "../services/adapter.js?v=20260907-003";
import { detectToolCalls, stripToolCalls, hasTruncatedTail, executeToolCalls } from "../services/tools.js?v=20260907-003";
import { renderMarkdown } from "../services/markdown.js?v=20260907-003";
import { mToast, t } from "./m-ui.js?v=20260907-003";
import { mHandleStructured } from "./m-auth.js?v=20260907-003";
import { setTopbarTitle, switchTab } from "./m-app.js?v=20260907-003";
