...
} from "../store.js?v=20260921-003";
import { fmtTokens } from "../services/usage.js?v=20260921-003";
import { get, post, patch, streamChat, REASONING_PREFIX, REASONING_INLINE_PREFIX } from "../services/api.js?v=20260921-003";
import { buildMessages, getDefaultParams, getOutputMaxTokens } from "../services/adapter.js?v=20260921-003";
import { detectToolCalls, detectDsmlCalls, hasToolMarkup, stripToolCalls, hasTruncatedTail, executeToolCalls } from "../services/tools.js?v=20260921-003";
import { dedupeToolCalls, MOBILE_TOOL_RESULT_STATUS, MOBILE_FAILED_LINE, formatToolResultForModel, buildToolFollowupInstruction, isHistorySummary } from "../services/agent_common.js?v=20260921-003";
import { createAgentLoop } from "../services/agent_loop.js?v=20260921-003";
import { openRun as openLedgerRun, projectChat } from "../services/agent_ledger.js?v=20260921-003";
import { toolLabel } from "../services/tool_meta.js?v=20260921-003";
import { renderMarkdown } from "../services/markdown.js?v=20260921-003";
import { mToast, t } from "./m-ui.js?v=20260921-003";
import { mHandleStructured } from "./m-auth.js?v=20260921-003";
import { setTopbarTitle, switchTab } from "./m-app.js?v=20260921-003";
