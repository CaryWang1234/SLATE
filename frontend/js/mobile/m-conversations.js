...
import { state, setConversations } from "../store.js?v=20260830-003";
import { get, patch, del } from "../services/api.js?v=20260830-003";
import { t, mToast, mShowPrompt, mShowConfirm, mIcon } from "./m-ui.js?v=20260830-003";
import { mLoadConversation, mNewConversation } from "./m-chat.js?v=20260830-003";
import { onTab, switchTab } from "./m-app.js?v=20260830-003";
      ...
      try {
        ...
        if (res.code !== 0) mToast(res.message || t("删除失败"), 3200);
          ...
          if (state.currentConversationId === conv.id) {
            ...
            const { setMessages } = await import("../store.js?v=20260830-003");
            setMessages([]);
          }
          await refreshConversations();
          renderList();
