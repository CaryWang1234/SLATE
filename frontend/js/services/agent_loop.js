...
import { state, addMessage } from "../store.js?v=20260925-008";
import { stripToolCalls } from "./tools.js?v=20260925-008";
import { _pendingToolMsgs, releasePendingFor } from "./agent_common.js?v=20260925-008";
