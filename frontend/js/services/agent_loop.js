...
import { state, addMessage } from "../store.js?v=20260907-022";
import { stripToolCalls } from "./tools.js?v=20260907-022";
import { _pendingToolMsgs } from "./agent_common.js?v=20260907-022";
