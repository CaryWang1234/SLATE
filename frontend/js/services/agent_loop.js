...
import { state, addMessage } from "../store.js?v=20260913-007";
import { stripToolCalls } from "./tools.js?v=20260913-007";
import { _pendingToolMsgs } from "./agent_common.js?v=20260913-007";
