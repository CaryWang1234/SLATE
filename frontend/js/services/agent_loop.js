...
import { state, addMessage } from "../store.js?v=20260911-001";
import { stripToolCalls } from "./tools.js?v=20260911-001";
import { _pendingToolMsgs } from "./agent_common.js?v=20260911-001";
