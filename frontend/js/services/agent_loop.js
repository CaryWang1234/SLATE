...
import { state, addMessage } from "../store.js?v=20260912-002";
import { stripToolCalls } from "./tools.js?v=20260912-002";
import { _pendingToolMsgs } from "./agent_common.js?v=20260912-002";
