...
import { state, addBoardCard, setBoardCards, getConversationTodos, setConversationTodos, setActions, setHarnessEnabled, requestLoopExit, effectiveConstitution, permissionModeFor } from "../store.js?v=20260925-008";
import { get, post, put, runSkillStream, REASONING_PREFIX, REASONING_INLINE_PREFIX } from "../services/api.js?v=20260925-008";
import { guardSkillCall } from "./riskguard.js?v=20260925-008";
import { isTruncatedUnexecutable } from "./agent_common.js?v=20260925-008";
import { dlgUserAsk, dlgConfirm } from "./dialog.js?v=20260925-008";
import { t } from "./i18n.js?v=20260925-008";
import { makeId } from "./utils.js?v=20260925-008";
import { runSubAgents, getSubAgentSignal, SUBAGENT_MAX_PARALLEL, SUBAGENT_OUTPUT_LIMIT } from "./subagent.js?v=20260925-008";
import { startSubAgentJob, BG_SUBAGENT_MAX_JOBS } from "./subagent_jobs.js?v=20260925-008";
import { noteBgTaskStarted } from "./bg_tasks.js?v=20260925-008";
import { isAiToolOff } from "./ai_features.js?v=20260925-008";
import { projectScopeOf, catalogForScope, forgetScopeCatalog } from "./project_scope.js?v=20260925-008";
