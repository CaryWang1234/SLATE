...
} from "../frontend/js/components/game_2048.js?v=20260925-001";
import {
  WEEKS, buildGrid, monthLabels, levelFor,
} from "../frontend/js/components/usage_heatmap.js?v=20260925-001";
...
{
  const src = readFileSync(new URL("../frontend/js/components/usage_heatmap.js?v=20260925-001", import.meta.url), "utf8");
  ...
  const game = readFileSync(new URL("../frontend/js/components/game_2048.js?v=20260925-001", import.meta.url), "utf8");
