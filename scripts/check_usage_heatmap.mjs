...
} from "../frontend/js/components/game_2048.js?v=20260925-008";
import {
  WEEKS, buildGrid, monthLabels, levelFor,
} from "../frontend/js/components/usage_heatmap.js?v=20260925-008";
import { EN_DICT } from "../frontend/js/services/i18n_dict.js?v=20260925-008";
...
{
  const src = readFileSync(new URL("../frontend/js/components/usage_heatmap.js?v=20260925-008", import.meta.url), "utf8");
  ...
  const game = readFileSync(new URL("../frontend/js/components/game_2048.js?v=20260925-008", import.meta.url), "utf8");
