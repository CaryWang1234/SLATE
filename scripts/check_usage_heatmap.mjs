...
} from "../frontend/js/components/game_2048.js?v=20260919-002";
import {
  WEEKS, buildGrid, monthLabels, levelFor,
} from "../frontend/js/components/usage_heatmap.js?v=20260919-002";
import { EN_DICT } from "../frontend/js/services/i18n_dict.js?v=20260919-002";
...
{
  const src = readFileSync(new URL("../frontend/js/components/usage_heatmap.js?v=20260919-002", import.meta.url), "utf8");
